...
public interface UserDAO {
	 ...
	 * 회원가입
	 */
	@Insert("INSERT INTO spring_user(" + "u_id,u_pw,u_profile,u_name,u_phone,u_birth,u_addr,u_addr_detail,u_addr_post"
			+ ")VALUES(" + " #{u_id}, " + "#{u_pw}," + "#{u_profile}," + "#{u_name}," + "#{u_phone}," + "#{u_birth},"
			+ "#{u_addr}," + "#{u_addr_detail}," + "#{u_addr_post}" + ")")
